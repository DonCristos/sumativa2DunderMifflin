...
class DepartamentoResourceIT {
    ...
    private static final Double DEFAULT_PRESUPUESTO_DEPARTAMENTO = 1D;
    private static final Double UPDATED_PRESUPUESTO_DEPARTAMENTO = 2D;
    ...
    void getAllDepartamentos() throws Exception {
        ...
        restDepartamentoMockMvc
            ...
            .andExpect(jsonPath("$.[*].presupuestoDepartamento").value(hasItem(DEFAULT_PRESUPUESTO_DEPARTAMENTO.doubleValue())));
    }
    ...
    void getDepartamento() throws Exception {
        ...
        restDepartamentoMockMvc
            ...
            .andExpect(jsonPath("$.presupuestoDepartamento").value(DEFAULT_PRESUPUESTO_DEPARTAMENTO.doubleValue()));
    }
