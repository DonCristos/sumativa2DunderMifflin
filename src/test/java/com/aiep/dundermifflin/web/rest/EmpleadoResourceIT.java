...
import com.aiep.dundermifflin.repository.EmpleadoRepository;
...
class EmpleadoResourceIT {
    ...
    public static Empleado createEntity() {
        return new Empleado()
            ...
            .telefonoEmpleado(DEFAULT_TELEFONO_EMPLEADO)
            .correoEmpleado(DEFAULT_CORREO_EMPLEADO);
    }
    ...
    public static Empleado createUpdatedEntity() {
        return new Empleado()
            ...
            .telefonoEmpleado(UPDATED_TELEFONO_EMPLEADO)
            .correoEmpleado(UPDATED_CORREO_EMPLEADO);
    }
    ...
    @Test
    @Transactional
    void checkApellidoEmpleadoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        empleado.setApellidoEmpleado(null);
    ...
    void getAllEmpleados() throws Exception {
        ...
        restEmpleadoMockMvc
            ...
            .andExpect(jsonPath("$.[*].telefonoEmpleado").value(hasItem(DEFAULT_TELEFONO_EMPLEADO)))
            .andExpect(jsonPath("$.[*].correoEmpleado").value(hasItem(DEFAULT_CORREO_EMPLEADO)));
    }
    ...
    void getEmpleado() throws Exception {
        ...
        restEmpleadoMockMvc
            ...
            .andExpect(jsonPath("$.telefonoEmpleado").value(DEFAULT_TELEFONO_EMPLEADO))
            .andExpect(jsonPath("$.correoEmpleado").value(DEFAULT_CORREO_EMPLEADO));
    }
    ...
    void partialUpdateEmpleadoWithPatch() throws Exception {
        ...
        partialUpdatedEmpleado.nombreEmpleado(UPDATED_NOMBRE_EMPLEADO);
